...
import { Container, Carousel, Row, Col, Button, Stack } from 'react-bootstrap';
            ...
            <Col xs={4} className="bg-dark gameCart sticky-top">
              <div className='gameCart'>
                ...
                <Row className='centered-alignment'>
                    <Col xl={8}><h3 className='text-start title'>{this.state.game.data && this.state.game.data.attributes.title}</h3></Col>
                    <Col><h5 className='text-center fw-bold text-info'>{this.state.game.data && this.state.game.data.attributes.price + " €"}</h5></Col>
                </Row>
                ...
                <Row className='centered-alignment'>
                  ...
                  <Col>
                    <p>{ this.state.game.data && this.state.game.data.attributes.launched_date}</p>
                  </Col>
                </Row>
